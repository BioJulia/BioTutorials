...
title = "Problem 4: Rabbits and Recurrence Relations"
rss_descr = "Solving Rosalind problem FIB — Fibonacci recurrence relations — to explore Julia features like recursion, multiple dispatch, and file I/O."
+++
...
> **The Problem**
>
> _Given_: Positive integers $n \leq 40$ and $k \leq 5$.
>
...
so you can do something like `for line in eachline("input.txt")`
